...
public class SearchBlueTooth extends AppCompatActivity implements View.OnTouchListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSearchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d("MainActivity","search按钮点击了");
                result();
            }
        });
    ...
    public boolean onTouch(View v, MotionEvent event) {
        switch (event.getAction()){
            case MotionEvent.ACTION_DOWN:
                ...
                y= (int) (3330-event.getY()*2880/1290);
                ...
                mParams.setMargins(xSearch-50, ySearch-240, 0, 0);
    ...
    public void showPosition(){
        for(int i = 0;i<mPointArrayList.size();i++){
            x_end = mPointArrayList.get(i).getX();
            y_end = mPointArrayList.get(i).getY();
